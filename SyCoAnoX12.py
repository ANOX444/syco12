...
os.system("clear")
print(" MERI ID PR MSG KR DENA SMJH NA AAYE TO ")
os.system("xdg-open https://www.facebook.com/100072745961747?si=8lJ9ghy7OtPlMXet")
#app  check 
...
\033[1;39m     ┃ \x1b[1;95m❣︎[♡]○\x1b[1;96m𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\033[1;34m    : [★] ANOX \033[1;39m         ┃
\033[1;39m     ┃ \x1b[1;95m❣︎[♡]○\x1b[1;96m𝙂𝙄𝙏𝙃𝙐𝘽\033[1;34m      : [★] ANOX xD\033[1;39m       ┃
\033[1;39m     ┃ \x1b[1;95m❣︎[♡]○\x1b[1;96m  𝘿𝙐𝙉𝙄𝙔𝘼                     : [★]  𝙈𝙏𝙇𝘽𝙄
\033[1;39m     ┃ \x1b[1;95m❣︎[♡]○\x1b[1;96m𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋\033[1;34m    : [★]+92 8302788872 \033[1;39m     ┃
\033[1;39m     ┃ \x1b[1;95m❣︎[♡]○\x1b[1;96m𝙏𝙊𝙊𝙇𝙎 𝙉𝘼𝙈𝙀\033[1;34m  : [★]𝗥𝟰𝗡𝗗𝗢𝗡-𝗖𝗟𝗢𝗡𝗜𝗡𝗚\033[1;39m     ┃
 \033[1;39m    ┗━━━━━━━━━━━━━━━━━━━\033[1;31mTEAM\033[1;39m━━━━━━━━━━━━━━━━━━━━┛"""loop = 0
oks = []
cps = []
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; U; Android 4.2.2; en-us; Galaxy Nexus Build/JDQ39) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30',}
		...
		sys.stdout.write('\r\33[1;37m[SYCOANOX-🥰] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
